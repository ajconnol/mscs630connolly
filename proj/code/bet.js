...
function BetScreen({ navigation }) {
    ...
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'top', marginTop: 20 }}>
        <Button
          title="Fetch Bet"
          onPress={() => onSubmit()}
        />
